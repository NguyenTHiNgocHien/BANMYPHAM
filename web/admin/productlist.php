...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['delete'])) {
        $result2 = $product->delete($_POST['id2']);
        if ($result2) {
...
<body>
    <nav>
        ...
        <ul>
            <li><a href="../login.php" class="active">Đăng Xuất </a></li>
    ...
    <div class="addNew">
        <a href="add_product.php"><h2>Thêm mới</a></h2>
    </div>
    <div class="container">
        <?php $count = 1;
        if ($list) { ?>
                ...
                <?php foreach ($list as $key => $value) { ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <?php } ?>
                            <form action="productlist.php" method="post">
                                    <input type="text" name="id2" hidden value="<?= $value['id'] ?>" style="display: none;">
